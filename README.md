...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,700 | 🐛 106 | 📅 2026-09-02 [![Build Status](https://travis-ci.org/snlab-freedom/awesome-sdn.svg?branch=master)](https://travis-ci.org/snlab-freedom/awesome-sdn)

A curated list of awesome SDN (Software Defined Networking) papers, projects and communities. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 184,747 | 🐛 230 | 🌐 Go | 📅 2026-09-18 and [awesome-deep-learning-papers](https://github.com/terryum/awesome-deep-learning-papers) ⭐ 26,191 | 🐛 37 | 🌐 TeX | 📅 2024-01-18.
...
* [Floodlight](https://github.com/floodlight/floodlight) ⭐ 771 | 🐛 62 | 🌐 Java | 📅 2024-04-26 - A java-based openflow controller.
* [POX](https://github.com/noxrepo/pox) ⭐ 647 | 🐛 48 | 🌐 Python | 📅 2024-10-19 - A networking software platform written in Python
...
* [Beehive Network Controller](https://github.com/kandoo/beehive-netctrl) ⭐ 72 | 🐛 2 | 🌐 Go | 📅 2016-03-14 - A distributed SDN controller built on top of Beehive. It supports OpenFlow but can be easily extended for other southbound protocols.
...
* [OESS](https://github.com/globalnoc/oess) ⭐ 28 | 🐛 66 | 🌐 JavaScript | 📅 2023-04-12 - The Open Exchange Software Suite to configure and control OpenFlow Enabled switches.
* [Ravel](https://github.com/ravel-net/ravel) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2018-06-20 - A software-defined networking (SDN) controller that uses a standard SQL database to represent the network.
...
* [snabbswitch](https://github.com/SnabbCo/snabbswitch) ⭐ 3,031 | 🐛 15 | 🌐 Lua | 📅 2026-07-30 - An open source virtualized Ethernet networking stack.
...
* [Frenetic](https://github.com/frenetic-lang/frenetic) ⭐ 229 | 🐛 22 | 🌐 OCaml | 📅 2023-11-14 - The Frenetic Programming Language and Runtime System
...
* [loxigen](https://github.com/floodlight/loxigen) ⭐ 97 | 🐛 25 | 🌐 Python | 📅 2023-04-15 - LoxiGen is a tool that generates OpenFlow protocol libraries for a number of languages.
* [openfaucet](https://github.com/rlenglet/openfaucet) ⭐ 26 | 🐛 0 | 🌐 Python | 📅 2012-10-10 - openfaucet is a pure Python implementation of the OpenFlow 1.0.0
  protocol, based on Twisted.
* [oflib-node](https://github.com/TrafficLab/oflib-node) ⭐ 15 | 🐛 0 | 🌐 JavaScript | 📅 2011-12-17 - Oflib-node is an OpenFlow protocol library for Node. It converts between OpenFlow wire protocol messages and Javascript objects.
* [OCaml OpenFlow](https://github.com/frenetic-lang/ocaml-openflow) ⭐ 13 | 🐛 17 | 🌐 OCaml | 📅 2015-07-16 - A serialization and protocol library for OpenFlow.
...
* [OpenNet](http://github.com/dlinknctu/opennet) ⭐ 73 | 🐛 49 | 🌐 Shell | 📅 2017-09-20 - A simulator for software-defined wireless local area network.
* [Multinet](https://github.com/intracom-telecom-sdn/multinet) ⭐ 14 | 🐛 2 | 🌐 Python | 📅 2017-02-28 - The goal of Multinet is to provide a fast, controlled and resource-efficient way to boot large-scale SDN topologies.
...
* [NetIDE](https://github.com/fp7-netide/Engine) ⭐ 10 | 🐛 24 | 🌐 Java | 📅 2022-12-07 - Enable Network App programs to be executed, systematically tested, and refined on a variety of concrete SDN platforms.
...
* [oftest](https://github.com/floodlight/oftest) ⭐ 85 | 🐛 32 | 🌐 Python | 📅 2024-01-25 - OpenFlow Testing Framework.
* [OFLOPS](https://github.com/mininet/oflops) ⭐ 32 | 🐛 6 | 🌐 C | 📅 2023-04-22 - OpenFlow Operations Per Second. A benchmarking suite for openflow switches.
